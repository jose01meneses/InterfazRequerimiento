  ...
  <EllipsisDropdown
    menu={
      <Menu>
        <Menu.Item>
          <EyeOutlined />
          <span onClick={() => redirectToDetail("./sga-detail")}>
            Ver detalle
          </span>
        </Menu.Item>
      </Menu>
      ...
      <PageHeaderAlt className="border-bottom">
        <div className="container-fluid">
          <Flex justifyContent="between" alignItems="center" className="py-4">
            <h2>Gastos Generales, de Venta y Administrativos Mensual</h2>
          </Flex>
        </div>
      </PageHeaderAlt>
      <div
